...
extern NSString *const TXLFMDBVersion;
extern NSString *const TXLWCDBVersion;

//数据库缓存的路径
#define TXLCachePath [NSString stringWithFormat:@"%@/database",NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES).firstObject]

@interface TXLFMDBManagement : NSObject
